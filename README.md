...
- [ ] Use a FlatList component in List.js; **DONE**
- [ ] Refactor all styles to use `styled-components`; **DONE**
- [ ] Implement a navigation from the List page to the Details page using `react-navigation`; **DONE** 
- [ ] Create the Pokemon Details Page using the provided [Figma](https://www.figma.com/file/m7h8wWZO3u6qCC3Edw1BGU/taqchallenge-(Copy)?node-id=0%3A1) as reference; **DONE** 
- [ ] Use [PokeAPI](https://pokeapi.co/) to populate the Pokemon List Page (https://pokeapi.co/api/v2/pokemon); **DONE** 
- [ ] Use  [PokeAPI](https://pokeapi.co/) to populate the Pokemon Details Page (https://pokeapi.co/api/v2/pokemon/ditto); **DONE** 
- [ ] Implement a share button in the Details page to share a message with the Pokemon's stats. **DONE** 
